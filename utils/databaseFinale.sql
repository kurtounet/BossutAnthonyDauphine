...
-- Listage des données de la table dauphineexam.annonce : ~6 rows (environ)
INSERT INTO `annonce` (`id`, `imageUrl`, `contenu`, `titre`, `auteur`, `datePublication`) VALUES
	...
	(60, 'https://localhost/bossutanthonydauphine/assets/uploads/lotus.png', 'Ma Nouvelle annonce placehold -> oiseau2', 'Ma Nouvelle annonce placehold -> Modif tout 2', 'Moi -> oiseau2', '2024-04-27 16:50:20'),
	(62, 'https://localhost/bossutanthonydauphine/assets/uploads/oiseau.png', 'Nouvelle annonce\r\nTitre:', 'Nouvelle annonce Titre:', 'Nouvelle annonce Titre:', '2024-04-27 16:50:51');
...
INSERT INTO `utilisateur` (`id`, `username`, `nom`, `prenom`, `password`) VALUES
	(1, 'jose', 'Bové', 'Jose', '$2y$10$IVM8mcb63F9YhzHEXpOZC./HT7S4oxFQVThCzX9u6av6MQvgJ9CNK');
